...
interface IRuntimeObjects {
	...
	['TraceMap']: IObjectClass<ITraceMap>;
	['TraceArray']: IObjectClass<ITraceArray>;
	['Touch']: IObjectClass<ITouch>;
	['TiledBackground']: IObjectClass<ITiledBackground>;
	['TextUI']: IObjectClass<ITextUI>;
	['TextTutorial']: IObjectClass<ITextTutorial>;
	['SliderBG']: IObjectClass<ISliderBG>;
	['Slider']: IObjectClass<ISlider>;
	['ShadowLight']: IObjectClass<IShadowLight>;
	['PointerIcon']: IObjectClass<IPointerIcon>;
	['Pointer']: IObjectClass<IPointer>;
	['Player']: IObjectClass<IPlayer>;
	['PlatformInfo']: IObjectClass<IPlatformInfo>;
	['NearestTeleporters']: IObjectClass<INearestTeleporters>;
	['MobileButton']: IObjectClass<IMobileButton>;
	['MenuButton']: IObjectClass<IMenuButton>;
	['LocalStorage']: IObjectClass<ILocalStorage>;
	['levelSelect']: IObjectClass<IlevelSelect>;
	['LevelData']: IObjectClass<ILevelData>;
	['LevelButton']: IObjectClass<ILevelButton>;
	['Lantern']: IObjectClass<ILantern>;
	['Keyboard']: IObjectClass<IKeyboard>;
	['cam']: IObjectClass<Icam>;
	['Browser']: IObjectClass<IBrowser>;
	['BlackBG']: IObjectClass<IBlackBG>;
	['Background']: IObjectClass<IBackground>;
	['Audio']: IObjectClass<IAudio>;
	['AJAX']: IObjectClass<IAJAX>;
	['Goal']: IObjectClass<IGoal>;
	['Teleporter']: IObjectClass<ITeleporter>;
	['Marker']: IObjectClass<IMarker>;
	['Activable']: IObjectClass<IActivable>;
}
...
interface IWallBehaviors extends Record<string, IBehaviorInstance> {
	...
	['ShadowCaster']: IBehaviorInstance
}
interface IWall extends ITilemapInstance {
	instVars: IWallVars;
	behaviors: IWallBehaviors;
}

interface ITraceMapVars extends VariableType {
	
}
interface ITraceMapBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITraceMap extends IDrawingCanvasInstance {
	instVars: ITraceMapVars;
	behaviors: ITraceMapBehaviors;
}

interface ITraceArrayVars extends VariableType {
	
}
interface ITraceArrayBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITraceArray extends IInstance {
	instVars: ITraceArrayVars;
	behaviors: ITraceArrayBehaviors;
}
...
interface ITextUIVars extends VariableType {
	/**  **/
	['id']: number;
}
interface ITextUIBehaviors extends Record<string, IBehaviorInstance> {
	['Tween']: IBehaviorInstance
}
interface ITextUI extends IWorldInstance {
	instVars: ITextUIVars;
	behaviors: ITextUIBehaviors;
}

interface ITextTutorialVars extends VariableType {
	/**  **/
	['id']: number;
}
interface ITextTutorialBehaviors extends Record<string, IBehaviorInstance> {
	['Fade']: IBehaviorInstance
	['Tween']: IBehaviorInstance
}
interface ITextTutorial extends IWorldInstance {
	instVars: ITextTutorialVars;
	behaviors: ITextTutorialBehaviors;
}

interface ISliderBGVars extends VariableType {
	/**  **/
	['id']: number;
}
interface ISliderBGBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ISliderBG extends IWorldInstance {
	instVars: ISliderBGVars;
	behaviors: ISliderBGBehaviors;
}

interface ISliderVars extends VariableType {
	/**  **/
	['id']: number;
}
interface ISliderBehaviors extends Record<string, IBehaviorInstance> {
	['DragDrop']: IBehaviorInstance
}
interface ISlider extends ISpriteInstance {
	instVars: ISliderVars;
	behaviors: ISliderBehaviors;
}

interface IShadowLightVars extends VariableType {
	
}
interface IShadowLightBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IShadowLight extends IWorldInstance {
	instVars: IShadowLightVars;
	behaviors: IShadowLightBehaviors;
}

interface IPointerIconVars extends VariableType {
	
}
interface IPointerIconBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IPointerIcon extends ISpriteInstance {
	instVars: IPointerIconVars;
	behaviors: IPointerIconBehaviors;
}

interface IPointerVars extends VariableType {
	/**  **/
	['finding']: number;
}
interface IPointerBehaviors extends Record<string, IBehaviorInstance> {
	['Pathfinding']: IPathfindingBehaviorInstance
}
interface IPointer extends ISpriteInstance {
	instVars: IPointerVars;
	behaviors: IPointerBehaviors;
}
...
interface IPlayerBehaviors extends Record<string, IBehaviorInstance> {
	['TileMovement']: ITileMovementBehaviourInstance
}
...
interface IPlatformInfoVars extends VariableType {
	
}
interface IPlatformInfoBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IPlatformInfo extends IWorldInstance {
	instVars: IPlatformInfoVars;
	behaviors: IPlatformInfoBehaviors;
}

interface INearestTeleportersVars extends VariableType {
	
}
interface INearestTeleportersBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface INearestTeleporters extends IInstance {
	instVars: INearestTeleportersVars;
	behaviors: INearestTeleportersBehaviors;
}

interface IMobileButtonVars extends VariableType {
	
}
interface IMobileButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IMobileButton extends ISpriteInstance {
	instVars: IMobileButtonVars;
	behaviors: IMobileButtonBehaviors;
}

interface IMenuButtonVars extends VariableType {
	
}
interface IMenuButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IMenuButton extends ISpriteInstance {
	instVars: IMenuButtonVars;
	behaviors: IMenuButtonBehaviors;
}
...
interface IlevelSelectVars extends VariableType {
	/**  **/
	['id']: number;
}
interface IlevelSelectBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IlevelSelect extends ISpriteInstance {
	instVars: IlevelSelectVars;
	behaviors: IlevelSelectBehaviors;
}

interface ILevelDataVars extends VariableType {
	
}
interface ILevelDataBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ILevelData extends IInstance {
	instVars: ILevelDataVars;
	behaviors: ILevelDataBehaviors;
}

interface ILevelButtonVars extends VariableType {
	
}
interface ILevelButtonBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ILevelButton extends ISpriteInstance {
	instVars: ILevelButtonVars;
	behaviors: ILevelButtonBehaviors;
}

interface ILanternVars extends VariableType {
	
}
interface ILanternBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ILantern extends ISpriteInstance {
	instVars: ILanternVars;
	behaviors: ILanternBehaviors;
}
...
interface IBlackBGVars extends VariableType {
	
}
interface IBlackBGBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IBlackBG extends IWorldInstance {
	instVars: IBlackBGVars;
	behaviors: IBlackBGBehaviors;
}

interface IBackgroundVars extends VariableType {
	
}
interface IBackgroundBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IBackground extends IWorldInstance {
...
interface IGoalVars extends VariableType {
	/**  **/
	['isActive']: boolean;
	/**  **/
	['Maze']: number;
...
interface IGoalBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IGoal extends ISpriteInstance {
	instVars: IGoalVars;
	behaviors: IGoalBehaviors;
}

interface ITeleporterVars extends VariableType {
	/**  **/
	['isActive']: boolean;
	/**  **/
	['Maze']: number;
...
interface ITeleporterBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITeleporter extends ISpriteInstance {
	instVars: ITeleporterVars;
	behaviors: ITeleporterBehaviors;
}

interface IMarkerVars extends VariableType {
	/**  **/
	['isActive']: boolean;
	/**  **/
	['Maze']: number;
...
interface IMarkerBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IMarker extends ISpriteInstance {
	instVars: IMarkerVars;
	behaviors: IMarkerBehaviors;
}

interface IActivableVars extends VariableType {
	/**  **/
	['isActive']: boolean;
	/**  **/
	['Maze']: number;
...
interface IActivableBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IActivable extends ISpriteInstance {
	instVars: IActivableVars;
	behaviors: IActivableBehaviors;
}
